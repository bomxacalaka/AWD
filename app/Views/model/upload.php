...
<div class="container">
    <div class="row justify-content-between align-items-center col-md-6">
        <div class="col-auto">
            <a href="/model" class="btn btn-primary btn-long">Back</a>
        ...
        <!-- File upload form -->
        <form id="uploadForm" action="/model/upload" method="post" enctype="multipart/form-data">
            <?= csrf_field() ?>
            <div class="mb-3">
                <label for="profile_picture" class="form-label">Choose Model To Upload</label>
                <input type="file" class="form-control" id="profile_picture" name="model">
